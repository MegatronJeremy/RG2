...
PREDMET = [
    ...
    "одговора зависе меке сенке, затамњење у угловима, одрази и посредно осветљење. Ти ефекти се "
    "деценијама приближно рачунају у простору екрана или унапред, што не прати покретну геометрију.",
    ...
    "додају као пролази са праћењем зрака и малим бројем узорака, уз накнадну реконструкцију слике. "
    "Тај приступ је основа савремених комерцијалних система приказа, али се поштено поређење цене "
    "појава на хардверу различитих произвођача, над истим кодом, у литератури ретко среће.",
]
...
CILJ = [
    ...
    "класу сцене, дифузно посредно осветљење и два уређаја актуелне генерације.",
]
...
METODOLOGIJA = [
    ...
    "окружење које резултате пореди са сачуваним вредностима.",
    "Алати: C++, Vulkan са проширењима за праћење зрака, HLSL преведен у SPIR-V, и Python.",
]

SADRZAJ_MAP = [
    "Пет глава: Увод; Преглед постојећих решења; Опис реализације; Анализа; Закључак. "
    "Методологија и резултати су одељци Анализе, јер деле исту мерну поставку.",
]
