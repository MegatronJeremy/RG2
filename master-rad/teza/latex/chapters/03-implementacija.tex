...
then a variance-guided \`a-trous spatial filter, shared by all four signals. GI and AO run three
\`a-trous iterations by default and reflections none, for the reason measured in
