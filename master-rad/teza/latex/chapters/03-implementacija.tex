...
Directions are drawn from spatiotemporal blue noise, whose error sits at high frequencies, two
decorrelated dimensions per light, spreading
...
default, following the MegaLights approach: each pixel takes \texttt{render.shadows.rays} independent
samples, and each sample separately uses resampled importance sampling to pick \emph{one} light with
