...
rasterized forward renderer in a custom Vulkan engine. The noisy hemispheric effects (ambient occlusion, reflections, global
illumination) are reconstructed by a shared SVGF denoiser, while ray-traced shadows are traced inline
and resolved by temporal anti-aliasing. Real-time
