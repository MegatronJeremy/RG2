...
information. The noisy signals are reconstructed by a shared SVGF denoiser and stabilized by temporal
anti-aliasing. The per-effect GPU cost is isolated with an A/B configuration matrix, and
...
running identical code. The two vendors rank the effects differently: shadows dominate
on the RX 9070 XT (\perfEffShadowsAMD{} ms) while on the RTX 5070 shadows, reflections, and global
illumination cost the same to within the measurement spread, for measured real-time totals of
...
(\texttt{VK_KHR_ray_query}) prolaze iznad rasterizacionog forward prolaza, u endzinu koji je autor
sam napisao nad Vulkan-om. Rasterizacija te globalne efekte ina\v{c}e pribli\v{z}ava postupcima u
prostoru ekrana i unapred izra\v{c}unatim postupcima, koji otkazuju na geometriji van ekrana i na
dinami\v{c}koj sceni. \v{S}umoviti signali se rekonstrui\v{s}u zajedni\v{c}kim SVGF filtrom i
stabilizuju temporalnim anti-aliasing-om. Cena svakog efekta na grafi\v{c}kom procesoru izoluje se
...
efekte razli\v{c}ito: na RX 9070 XT senke dominiraju sa \perfEffShadowsAMD{} ms, dok na RTX 5070
senke, refleksije i globalno osvetljenje ko\v{s}taju isto u granicama mernog rasipanja, uz izmerene
ukupne vrednosti od \perfTotalAMD{} ms i \perfTotalNV{} ms nad osnovama od \perfBaseAMD{} i
\perfBaseNV{} ms. Izbor tehnike za senke je tako\dj e zavisan od arhitekture: stohasti\v{c}ki
producent je jeftiniji od inline trasiranja po svetlu na AMD-u, a 2,6 puta skuplji na NVIDIA-i.
